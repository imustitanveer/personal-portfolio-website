    ...
    <>
        ...
        <div className='flex flex-row gap-4 mt-4'>
          ...
          <div className='flex flex-row gap-4 items-center'>
            ...
            <div className='flex flex-col items-start font-[Inter]'>
              <h1 className='text-4xl text-black dark:text-white font-semibold'>Bachelor of Computer Science</h1>
              <h1 className='text-lg text-gray-600 dark:text-gray-400 font-semibold'>Iqra University, Karachi, Pakistan</h1>
              <h1 className='text-md text-gray-600 dark:text-gray-400 font-semibold'>JAN 2020 - DEC 2024</h1>
              <button 
              onClick={(e) => {
            ...
            <ul id="unitsList" className="list-disc list-inside text-gray-500 dark:text-gray-300 text-lg p-2 mx-auto text-justify hidden font-[DM_Sans]">
        ...
        <div className='flex flex-row gap-4 mt-4'>
          ...
          <div className='flex flex-row gap-4 items-center'>
            ...
            <div className='flex flex-col items-start font-[Inter]'>
              <h1 className='text-4xl text-black dark:text-white font-semibold font-[Montserrat]'>Intermediate in Computer Science</h1>
              <h1 className='text-lg text-gray-600 dark:text-gray-400 font-semibold'>NCR CET, Karachi, Pakistan</h1>
              <h1 className='text-md text-gray-600 dark:text-gray-400 font-semibold'>AUG 2017 - AUG 2019</h1>
              <button 
              onClick={(e) => {
              ...
              className='hover:cursor-pointer group flex flex-row gap-2 justify-center items-center font-[Inter]'
              data-state="closed"
            >
              <svg className='w-6 h-6 transition-transform duration-200 group-data-[state=open]:rotate-180 group-hover:text-gray-300 dakr:group-hover:text-white my-auto text-gray-500 dark:text-gray-300' 
                  viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <h1 className='text-lg text-gray-500 dark:text-gray-300 font-semibold group-hover:text-gray-300 dakr:group-hover:text-white'>View Units</h1>
            </button>
            </div>
          </div>
            <ul id="unitsList2" className="list-disc list-inside text-gray-500 dark:text-gray-300 text-lg p-2 mx-auto text-justify hidden font-[DM_Sans]">
