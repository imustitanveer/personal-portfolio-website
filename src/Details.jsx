...
function Details() {
  ...
  return (
    <>
        ...
        <button onClick={() => setIsEmailFormOpen(true)} className='bg-gray-400 text-white dark:bg-gray-800 p-2 my-4 text-md rounded-sm hover:bg-gray-700 hover:cursor-pointer hover:text-lg duration-300 font-[Inter]'>Get in Touch</button>
